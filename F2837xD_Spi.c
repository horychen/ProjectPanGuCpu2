...
void InitSpi4MAX5725(void)
{
    ...
    SpicRegs.SPICCR.bit.SPISWRESET = 0;
    {
        ...
        // SpicRegs.SPICCR.all = 0x008F   ;    // �ڸı�����ǰ��RESET���㣬�������ý���������λ
    ...
    while(SpicRegs.SPISTS.bit.INT_FLAG!=1){NOP;}    // ���ݴ����INT_FLAG����λ
    SpicRegs.SPITXBUF=0xFF00;
    while(SpicRegs.SPISTS.bit.INT_FLAG!=1){NOP;}    // ���ݴ����INT_FLAG����λ
    SpicRegs.SPITXBUF=0x0000;   //MAX5725�����ַ�
    while(SpicRegs.SPISTS.bit.INT_FLAG!=1){NOP;}    // ���ݴ����INT_FLAG����λ

    GpioDataRegs.GPCSET.bit.GPIO72 = 1;             //cs=1Ϊ��һ����׼��

    SpicRegs.SPICCR.bit.SPISWRESET=0;               //ͨ��reset ���SPI�жϱ�־INT_FLAG
    NOP;
    NOP;
...
void InitSpi4MAX5307(void)
{
    ...
    SpicRegs.SPITXBUF=0xfffc;                       //MAX5307�����ַ�
    while(SpicRegs.SPISTS.bit.INT_FLAG!=1){NOP;}    // ���ݴ����INT_FLAG����λ
